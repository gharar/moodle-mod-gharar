...
-   اصلاح متن تنظیم‌نشده برای دسترسی‌های نقش‌های گوناگون در تنظیمات دسترسی‌های نقش‌ها؛ برای نمونه، از این پس، قابل‌فهم‌تر است که چگونه یک نقش جدید را به عنوان استاد یا معلم برای قرار تنظیم کنید، تا هنگام ورود به اتاق، افرادی که این نقش را دارند، مدیر باشند
